...
<Callout title="Congenital vs Acquired Nipple Inversion — How to Tell" type="idea">
- **Congenital**: bilateral, longstanding (since puberty), the nipple can be manually everted ("Grade 1–2"), no associated mass or skin changes.
- **Acquired**: new-onset, usually unilateral, often progressive, may be associated with mass/discharge/skin changes. *Always* exclude malignancy with triple assessment.
</Callout>
...
<ActiveRecallQuiz
  ...
  items={[
    {
      question: "What is the most common cause of pathological (especially bloody) nipple discharge, and what is the mechanism of bleeding?",
      markscheme: "Intraductal papilloma. Muscularis arteries supply the papilloma via its peduncle, but veins and lymphatics are compromised, leading to increased vascular pressure causing transudation (serous) or vessel rupture (bloody discharge).",
    },
    {
      question: "A 55-year-old woman presents with unilateral nipple eczema, bloody discharge, and a palpable breast mass. What is the most likely diagnosis, what investigation is mandatory, and what is the pathological hallmark?",
      markscheme: "Paget disease of the nipple. Mandatory: mammography (to look for associated mass and exclude synchronous cancers). Pathological hallmark: malignant intraepithelial adenocarcinoma cells (Paget cells) within the nipple epidermis. Almost always associated with underlying breast cancer (HER2-positive).",
    },
    {
      question: "List three mechanisms by which hyperprolactinaemia causes galactorrhoea, giving one example for each.",
      markscheme: "(1) Autonomous prolactin secretion - e.g. prolactinoma. (2) Dopamine receptor blockade removing tonic inhibition - e.g. antipsychotics (haloperidol, risperidone) or antiemetics (metoclopramide). (3) Reduced prolactin clearance - e.g. hypothyroidism or CKD. Also accept: stalk compression (craniopharyngioma) interrupting dopamine delivery.",
    },
    {
      question: "How do you distinguish congenital from acquired nipple inversion clinically?",
      markscheme: "Congenital: bilateral, present since puberty, nipple can be manually everted, no associated mass or skin changes. Acquired: new-onset, usually unilateral, progressive, often non-evertible, may have associated mass/discharge/skin changes. Acquired inversion always requires triple assessment to exclude malignancy.",
    },
    {
      question: "What features of nipple discharge make it 'pathological' and warrant triple assessment?",
      markscheme: "Spontaneous, persistent, unilateral, single-duct, and serous (clear/yellow) or sanguineous (bloody) or serosanguineous. These features raise suspicion for intraductal papilloma, DCIS, or invasive carcinoma (malignancy in 5-15%).",
    },
    {
      question: "Describe the pathophysiology of nipple inversion in duct ectasia versus breast carcinoma.",
      markscheme: "Duct ectasia: subareolar ducts dilate with age, secretions become inspissated, periductal fibrosis develops, the fibrotic tissue contracts and pulls the nipple inward. Breast carcinoma: tumour grows along or around lactiferous ducts, causes a desmoplastic (fibrotic) reaction and directly shortens/retracts the ducts, pulling the nipple inward. Carcinoma-related inversion is typically unilateral, progressive, and non-evertible.",
    },
  ]}
/>
