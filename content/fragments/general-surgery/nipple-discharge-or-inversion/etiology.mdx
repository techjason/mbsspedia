...
- The Hong Kong Breast Cancer Foundation recommends monthly self-examination for all ages and annual mammography ± ultrasound from age ≥ 40 (or earlier if high risk) [3].
