...
<DiagramCard src="/diagrams/pancreas-anatomy.webp" alt="Pancreatic anatomy showing the head, uncinate process, neck, body, tail, and their relations to adjacent structures" caption="Pancreatic anatomy" />
