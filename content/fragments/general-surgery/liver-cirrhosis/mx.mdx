...
<Callout title="High-Yield Summary: Management Principles">
  ...
  **Always look for a precipitant.** 5. **HCC Staging & Treatment:** Think of
  the **"therapeutic window"** between tumor and liver function. In the local
  HKLC framework, ***Stages 1/2A*** map to **resection/ablation/transplant**,
  ***Stage 2B*** to **resection**, ***Stages 3A/3B*** to **TACE***,
  ***Stage 4A*** to **systemic therapy**, ***Stage 4B*** to **systemic therapy
  or palliative care**, ***Stage 5A*** to **transplant**, and ***Stage 5B*** to
  **palliative care**. 6. **Transplant:** The only cure for advanced cirrhosis.
  Milan Criteria are key for HCC.
</Callout>
