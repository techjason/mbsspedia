...
<ActiveRecallQuiz
  ...
  items={[
    {
      question: "Why is dopamine agonist first-line for prolactinoma but not for GH-secreting or ACTH-secreting adenomas? Explain the pharmacological basis.",
