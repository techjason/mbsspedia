...
import { type ComponentProps, type PointerEvent, use, useRef, useState } from 'react';
...
export function SidebarContent({
  ...
  function shouldIgnoreHover(e: PointerEvent<HTMLElement>): boolean {
    return !collapsed || e.pointerType === 'touch' || e.currentTarget.getAnimations().length > 0;
  }
